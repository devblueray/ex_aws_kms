defmodule ExAws.KMS do
  ...
  def get_public_key(key_id, opts \\ []) do
    ...
    request(:get_public_key, query_params)
  end
  ...
  @doc "Create a signature for a message or digest"
  @type sign_opts :: [
          {:grant_tokens, list(binary)}
          | {:message_type, binary}
        ]
  ...
  def sign(message, key_id, signing_algorithm, opts \\ []) do
    query_params =
      opts
      |> normalize_opts
      |> Map.merge(%{
  ...
  @doc "Verify a signature generated by the `sign` operation"
  @type verify_opts :: [
          {:grant_tokens, list(binary)}
          | {:message_type, binary}
        ]
  @spec verify(
          ...
          ExAws.Operation.JSON.t()
  def verify(message, signature, key_id, signing_algorithm, opts \\ []) do
    query_params =
      opts
      |> normalize_opts
      |> Map.merge(%{
